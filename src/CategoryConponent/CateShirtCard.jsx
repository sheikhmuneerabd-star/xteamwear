...
function CateShirtCard({ shirt, grid }) {
            ...
            <div className='group'>
                <div className={`${grid === 1 ? "flex" : "block"}`}>
                    ...
                    <div className={`${grid === 1 ? "ml-4 w-[73%]" : "md:pt-4 md:pl-4 md:pr-4 pt-3 pl-2 pb-0"}`}>
                        ...
                        <p className={`text-sm md:text-base lg:text-base text-gray-700 max-[320px]:hidden ${grid === 1 ? "block" : "hidden"}`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam at ut culpa a obcaecati aspernatur commodi deleniti esse quo consequatur.</p>
